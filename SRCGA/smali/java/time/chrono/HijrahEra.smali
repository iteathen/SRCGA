...
.field public static final enum BEFORE_AH:Ljava/time/chrono/HijrahEra;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Ljava/time/chrono/HijrahEra;-><init>(Ljava/lang/String;I)V

    sput-object v0, Ljava/time/chrono/HijrahEra;->BEFORE_AH:Ljava/time/chrono/HijrahEra;
...
.method private constructor <init>(Ljava/lang/String;I)V
    ...
    .local v0, "this":Ljava/time/chrono/HijrahEra;
    move-object v1, p1
...
.method public static of(I)Ljava/time/chrono/HijrahEra;
    ...
    const-string v3, "HijrahEra not valid"
    ...
    .line 91
    :pswitch_0
    sget-object v1, Ljava/time/chrono/HijrahEra;->BEFORE_AH:Ljava/time/chrono/HijrahEra;

    move-object v0, v1

    .line 93
    .end local v0    # "hijrahEra":I
    :goto_0
    return-object v0

    .restart local v0    # "hijrahEra":I
    :pswitch_1
...
.method static readExternal(Ljava/io/DataInput;)Ljava/time/chrono/HijrahEra;
    .locals 3
    ...
    invoke-static {v2}, Ljava/time/chrono/HijrahEra;->of(I)Ljava/time/chrono/HijrahEra;
...
.method public static valueOf(Ljava/lang/String;)Ljava/time/chrono/HijrahEra;
    ...
    const-class v1, Ljava/time/chrono/HijrahEra;
    ...
    check-cast v1, Ljava/time/chrono/HijrahEra;
...
.method private writeReplace()Ljava/lang/Object;
    ...
    .end local v0    # "this":Ljava/time/chrono/HijrahEra;
    return-object v0
.end method
...
.method public adjustInto(Ljava/time/temporal/Temporal;)Ljava/time/temporal/Temporal;
    ...
    invoke-virtual {v4}, Ljava/time/chrono/HijrahEra;->getValue()I
...
.method public get(Ljava/time/temporal/TemporalField;)I
    ...
    .local v1, "this":Ljava/time/chrono/HijrahEra;
    move-object v2, p1
    ...
    invoke-virtual {v3}, Ljava/time/chrono/HijrahEra;->getValue()I
    ...
    .line 137
    .end local v1    # "this":Ljava/time/chrono/HijrahEra;
    :goto_0
    return v1

    .restart local v1    # "this":Ljava/time/chrono/HijrahEra;
    :cond_0
    move-object v3, v1

    move-object v4, v2

    invoke-virtual {v3, v4}, Ljava/time/chrono/HijrahEra;->range(Ljava/time/temporal/TemporalField;)Ljava/time/temporal/ValueRange;
    ...
    invoke-virtual {v4, v5}, Ljava/time/chrono/HijrahEra;->getLong(Ljava/time/temporal/TemporalField;)J
...
.method public getLong(Ljava/time/temporal/TemporalField;)J
    ...
    .line 144
    .restart local v0    # "this":Ljava/time/chrono/HijrahEra;
    :cond_0
    move-object v2, v1
...
.method public getValue()I
    ...
    invoke-virtual {v1}, Ljava/time/chrono/HijrahEra;->ordinal()I

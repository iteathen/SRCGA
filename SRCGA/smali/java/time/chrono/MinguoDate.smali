...
.method constructor <init>(Ljava/time/LocalDate;)V
    ...
    .local v0, "this":Ljava/time/chrono/MinguoDate;
    move-object v1, p1
    ...
    iput-object v3, v2, Ljava/time/chrono/MinguoDate;->isoDate:Ljava/time/LocalDate;
...
.method public static from(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/MinguoDate;
    ...
    invoke-virtual {v1, v2}, Ljava/time/chrono/MinguoChronology;->date(Ljava/time/temporal/TemporalAccessor;)Ljava/time/chrono/MinguoDate;
...
.method private getProlepticMonth()J
    ...
    .local v1, "this":Ljava/time/chrono/MinguoDate;
    move-object v2, v1

    invoke-direct {v2}, Ljava/time/chrono/MinguoDate;->getProlepticYear()I
    ...
    iget-object v4, v4, Ljava/time/chrono/MinguoDate;->isoDate:Ljava/time/LocalDate;
    ...
    .end local v1    # "this":Ljava/time/chrono/MinguoDate;
    return-wide v1
.end method
...
.method private getProlepticYear()I
    ...
    iget-object v1, v1, Ljava/time/chrono/MinguoDate;->isoDate:Ljava/time/LocalDate;
    ...
    .end local v0    # "this":Ljava/time/chrono/MinguoDate;
    return v0
.end method
...
.method public static now(Ljava/time/Clock;)Ljava/time/chrono/MinguoDate;
    ...
    new-instance v1, Ljava/time/chrono/MinguoDate;
    ...
    invoke-direct {v2, v3}, Ljava/time/chrono/MinguoDate;-><init>(Ljava/time/LocalDate;)V
...
.method public static now(Ljava/time/ZoneId;)Ljava/time/chrono/MinguoDate;
    ...
    invoke-static {v1}, Ljava/time/chrono/MinguoDate;->now(Ljava/time/Clock;)Ljava/time/chrono/MinguoDate;
...
.method public static of(III)Ljava/time/chrono/MinguoDate;
    ...
    invoke-virtual {v3, v4, v5, v6}, Ljava/time/chrono/MinguoChronology;->date(III)Ljava/time/chrono/MinguoDate;
...
.method private with(Ljava/time/LocalDate;)Ljava/time/chrono/MinguoDate;
    ...
    iget-object v3, v3, Ljava/time/chrono/MinguoDate;->isoDate:Ljava/time/LocalDate;
    ...
    .restart local v0    # "this":Ljava/time/chrono/MinguoDate;
    :cond_0
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v3, v3, Ljava/time/chrono/MinguoDate;
    ...
    .line 350
    .local v2, "otherDate":Ljava/time/chrono/MinguoDate;
    move-object v3, v0
    ...
    .line 352
    .end local v2    # "otherDate":Ljava/time/chrono/MinguoDate;
    :cond_1
    const/4 v3, 0x0
...
.method public bridge synthetic getChronology()Ljava/time/chrono/AbstractChronology;
    ...
    invoke-virtual {v1}, Ljava/time/chrono/MinguoDate;->getChronology()Ljava/time/chrono/MinguoChronology;
...
.method public bridge synthetic getEra()Ljava/time/chrono/Era;
    ...
    invoke-virtual {v1}, Ljava/time/chrono/MinguoDate;->getEra()Ljava/time/chrono/MinguoEra;
...
.method public getLong(Ljava/time/temporal/TemporalField;)J
    ...
    .line 224
    sget-object v4, Ljava/time/chrono/MinguoDate$1;->$SwitchMap$java$time$temporal$ChronoField:[I
    ...
    .line 226
    .restart local v1    # "this":Ljava/time/chrono/MinguoDate;
    :pswitch_0
    move-object v4, v1

    invoke-direct {v4}, Ljava/time/chrono/MinguoDate;->getProlepticMonth()J
    ...
    invoke-direct {v4}, Ljava/time/chrono/MinguoDate;->getProlepticYear()I
...
.method public hashCode()I
    ...
    invoke-virtual {v1}, Ljava/time/chrono/MinguoChronology;->getId()Ljava/lang/String;
    ...
    iget-object v2, v2, Ljava/time/chrono/MinguoDate;->isoDate:Ljava/time/LocalDate;
...
.method public bridge synthetic minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/AbstractChronoLocalDate;
    ...
    invoke-virtual {v5, v6, v7, v8}, Ljava/time/chrono/MinguoDate;->minus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/MinguoDate;
...
.method public bridge synthetic minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/AbstractChronoLocalDate;
    ...
    invoke-virtual {v2, v3}, Ljava/time/chrono/MinguoDate;->minus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/MinguoDate;
...
.method public bridge synthetic plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/AbstractChronoLocalDate;
    ...
    invoke-virtual {v5, v6, v7, v8}, Ljava/time/chrono/MinguoDate;->plus(JLjava/time/temporal/TemporalUnit;)Ljava/time/chrono/MinguoDate;
...
.method public bridge synthetic plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/AbstractChronoLocalDate;
    ...
    invoke-virtual {v2, v3}, Ljava/time/chrono/MinguoDate;->plus(Ljava/time/temporal/TemporalAmount;)Ljava/time/chrono/MinguoDate;
...
.method bridge synthetic plusDays(J)Ljava/time/chrono/ChronoDateImpl;
    ...
    invoke-virtual {v3, v4, v5}, Ljava/time/chrono/MinguoDate;->plusDays(J)Ljava/time/chrono/MinguoDate;
...
.method plusDays(J)Ljava/time/chrono/MinguoDate;
    ...
    iget-object v5, v5, Ljava/time/chrono/MinguoDate;->isoDate:Ljava/time/LocalDate;
    ...
    invoke-direct {v4, v5}, Ljava/time/chrono/MinguoDate;->with(Ljava/time/LocalDate;)Ljava/time/chrono/MinguoDate;
...
.method bridge synthetic plusMonths(J)Ljava/time/chrono/ChronoDateImpl;
    ...
    invoke-virtual {v3, v4, v5}, Ljava/time/chrono/MinguoDate;->plusMonths(J)Ljava/time/chrono/MinguoDate;
...
.method bridge synthetic plusYears(J)Ljava/time/chrono/ChronoDateImpl;
    ...
    invoke-virtual {v3, v4, v5}, Ljava/time/chrono/MinguoDate;->plusYears(J)Ljava/time/chrono/MinguoDate;
...
.method public range(Ljava/time/temporal/TemporalField;)Ljava/time/temporal/ValueRange;
    ...
    invoke-virtual {v6, v7}, Ljava/time/chrono/MinguoDate;->isSupported(Ljava/time/temporal/TemporalField;)Z
    ...
    sget-object v6, Ljava/time/chrono/MinguoDate$1;->$SwitchMap$java$time$temporal$ChronoField:[I
    ...
    invoke-virtual {v6}, Ljava/time/chrono/MinguoDate;->getChronology()Ljava/time/chrono/MinguoChronology;

    move-result-object v6

    move-object v7, v2

    invoke-virtual {v6, v7}, Ljava/time/chrono/MinguoChronology;->range(Ljava/time/temporal/ChronoField;)Ljava/time/temporal/ValueRange;
    ...
    iget-object v6, v6, Ljava/time/chrono/MinguoDate;->isoDate:Ljava/time/LocalDate;
    ...
    invoke-direct {v6}, Ljava/time/chrono/MinguoDate;->getProlepticYear()I
...
.method public until(Ljava/time/chrono/AbstractChronoLocalDate;)Ljava/time/chrono/ChronoPeriod;
    ...
    invoke-virtual {v3}, Ljava/time/chrono/MinguoDate;->getChronology()Ljava/time/chrono/MinguoChronology;
    ...
    invoke-virtual {v3, v4, v5, v6}, Ljava/time/chrono/MinguoChronology;->period(III)Ljava/time/chrono/ChronoPeriod;
...
.method public bridge synthetic with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/AbstractChronoLocalDate;
    ...
    invoke-virtual {v2, v3}, Ljava/time/chrono/MinguoDate;->with(Ljava/time/temporal/TemporalAdjuster;)Ljava/time/chrono/MinguoDate;
...
.method public bridge synthetic with(Ljava/time/temporal/TemporalField;J)Ljava/time/chrono/AbstractChronoLocalDate;
    ...
    invoke-virtual {v4, v5, v6, v7}, Ljava/time/chrono/MinguoDate;->with(Ljava/time/temporal/TemporalField;J)Ljava/time/chrono/MinguoDate;
...
.method public with(Ljava/time/temporal/TemporalField;J)Ljava/time/chrono/MinguoDate;
    ...
    invoke-virtual {v6, v7}, Ljava/time/chrono/MinguoDate;->getLong(Ljava/time/temporal/TemporalField;)J
    ...
    iget-object v7, v7, Ljava/time/chrono/MinguoDate;->isoDate:Ljava/time/LocalDate;
    ...
    invoke-direct {v6, v7}, Ljava/time/chrono/MinguoDate;->with(Ljava/time/LocalDate;)Ljava/time/chrono/MinguoDate;
    ...
    invoke-direct {v9}, Ljava/time/chrono/MinguoDate;->getProlepticMonth()J

    move-result-wide v9

    sub-long/2addr v7, v9

    invoke-virtual {v6, v7, v8}, Ljava/time/chrono/MinguoDate;->plusMonths(J)Ljava/time/chrono/MinguoDate;
    ...
    invoke-direct {v8}, Ljava/time/chrono/MinguoDate;->getProlepticYear()I
    ...
    invoke-direct {v9}, Ljava/time/chrono/MinguoDate;->getProlepticYear()I
    ...
    check-cast v6, Ljava/time/chrono/MinguoDate;
...
.method writeExternal(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v3, v4}, Ljava/time/chrono/MinguoDate;->get(Ljava/time/temporal/TemporalField;)I

.class public Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;
.super Lcom/sun/scenario/effect/impl/sw/java/JSWEffectPeer;
.source "JSWBlend_COLOR_BURNPeer.java"
...
.method public constructor <init>(Lcom/sun/scenario/effect/FilterContext;Lcom/sun/scenario/effect/impl/Renderer;Ljava/lang/String;)V
    ...
    .local v0, "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;
    move-object v1, p1
...
.method private getOpacity()F
    ...
    invoke-virtual {v1}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->getEffect()Lcom/sun/scenario/effect/Blend;
    ...
    .end local v0    # "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;
    return v0
.end method
...
.method public varargs filter(Lcom/sun/scenario/effect/Effect;Lcom/sun/scenario/effect/impl/state/RenderState;Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/scenario/effect/ImageData;
    ...
    .local v2, "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;
    ...
    invoke-virtual/range {v89 .. v90}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->setEffect(Lcom/sun/scenario/effect/Effect;)V
    ...
    invoke-virtual/range {v89 .. v92}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->getResultBounds(Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/javafx/geom/Rectangle;
    ...
    invoke-virtual/range {v89 .. v90}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->setDestBounds(Lcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v89 .. v91}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->setInputBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v89 .. v91}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->setInputNativeBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v89 .. v97}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->getTextureCoordinates(I[FFFFFLcom/sun/javafx/geom/Rectangle;Lcom/sun/javafx/geom/transform/BaseTransform;)I
    ...
    invoke-virtual/range {v89 .. v89}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->getRenderer()Lcom/sun/scenario/effect/impl/Renderer;
    ...
    invoke-virtual/range {v89 .. v91}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->setDestNativeBounds(II)V
    ...
    invoke-direct/range {v89 .. v89}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->getOpacity()F
    ...
    .line 277
    .local v68, "blend_color_burn_res_x":F
    move/from16 v89, v81

    move/from16 v69, v89

    .line 278
    .local v69, "blend_color_burn_res_y":F
    move/from16 v89, v82

    move/from16 v70, v89

    .line 279
    .local v70, "blend_color_burn_res_z":F
    move/from16 v89, v83

    move/from16 v71, v89

    .line 283
    .local v71, "blend_color_burn_res_w":F
    move/from16 v89, v68
    ...
    .end local v68    # "blend_color_burn_res_x":F
    .end local v69    # "blend_color_burn_res_y":F
    .end local v70    # "blend_color_burn_res_z":F
    .end local v71    # "blend_color_burn_res_w":F
    ...
    .end local v85    # "topa2":F
    .end local v86    # "tmp_x":F
    .end local v87    # "tmp_y":F
    .end local v88    # "tmp_z":F
    .local v60, "loc_tmp_x":F
    .local v61, "loc_tmp_y":F
    .local v63, "iloc_tmp_x":I
    .local v64, "iloc_tmp_y":I
    ...
    .local v68, "blend_color_burn_res_x":F
    .local v69, "blend_color_burn_res_y":F
    .restart local v70    # "blend_color_burn_res_z":F
    .restart local v71    # "blend_color_burn_res_w":F
    :cond_15
    move/from16 v89, v42
    ...
    invoke-virtual/range {v91 .. v91}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;->getFilterContext()Lcom/sun/scenario/effect/FilterContext;
    ...
    .end local v2    # "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_BURNPeer;
    return-object v2
.end method

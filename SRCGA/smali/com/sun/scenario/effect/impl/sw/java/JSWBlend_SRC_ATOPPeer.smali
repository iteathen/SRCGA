.class public Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;
.super Lcom/sun/scenario/effect/impl/sw/java/JSWEffectPeer;
.source "JSWBlend_SRC_ATOPPeer.java"
...
.method public constructor <init>(Lcom/sun/scenario/effect/FilterContext;Lcom/sun/scenario/effect/impl/Renderer;Ljava/lang/String;)V
    ...
    .local v0, "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;
    move-object v1, p1
...
.method private getOpacity()F
    ...
    invoke-virtual {v1}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->getEffect()Lcom/sun/scenario/effect/Blend;
    ...
    .end local v0    # "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;
    return v0
.end method
...
.method public varargs filter(Lcom/sun/scenario/effect/Effect;Lcom/sun/scenario/effect/impl/state/RenderState;Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/scenario/effect/ImageData;
    ...
    .local v2, "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;
    ...
    invoke-virtual/range {v80 .. v81}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->setEffect(Lcom/sun/scenario/effect/Effect;)V
    ...
    invoke-virtual/range {v80 .. v83}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->getResultBounds(Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/javafx/geom/Rectangle;
    ...
    invoke-virtual/range {v80 .. v81}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->setDestBounds(Lcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v80 .. v82}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->setInputBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v80 .. v82}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->setInputNativeBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v80 .. v88}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->getTextureCoordinates(I[FFFFFLcom/sun/javafx/geom/Rectangle;Lcom/sun/javafx/geom/transform/BaseTransform;)I
    ...
    invoke-virtual/range {v80 .. v80}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->getRenderer()Lcom/sun/scenario/effect/impl/Renderer;
    ...
    invoke-virtual/range {v80 .. v82}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->setDestNativeBounds(II)V
    ...
    invoke-direct/range {v80 .. v80}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->getOpacity()F
    ...
    .line 216
    .local v68, "blend_src_atop_res_x":F
    move/from16 v80, v77
    ...
    .line 217
    .local v69, "blend_src_atop_res_y":F
    move/from16 v80, v78
    ...
    .line 218
    .local v70, "blend_src_atop_res_z":F
    move/from16 v80, v79
    ...
    .line 222
    .local v71, "blend_src_atop_res_w":F
    move/from16 v80, v68
    ...
    .end local v68    # "blend_src_atop_res_x":F
    .end local v69    # "blend_src_atop_res_y":F
    .end local v70    # "blend_src_atop_res_z":F
    .end local v71    # "blend_src_atop_res_w":F
    ...
    .local v68, "blend_src_atop_res_x":F
    .local v69, "blend_src_atop_res_y":F
    .restart local v70    # "blend_src_atop_res_z":F
    .restart local v71    # "blend_src_atop_res_w":F
    ...
    invoke-virtual/range {v82 .. v82}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;->getFilterContext()Lcom/sun/scenario/effect/FilterContext;
    ...
    .end local v2    # "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_SRC_ATOPPeer;
    return-object v2
.end method

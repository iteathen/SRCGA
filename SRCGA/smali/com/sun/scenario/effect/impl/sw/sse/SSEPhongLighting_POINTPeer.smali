.class public Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;
.super Lcom/sun/scenario/effect/impl/sw/sse/SSEEffectPeer;
.source "SSEPhongLighting_POINTPeer.java"
...
.method public constructor <init>(Lcom/sun/scenario/effect/FilterContext;Lcom/sun/scenario/effect/impl/Renderer;Ljava/lang/String;)V
    ...
    .local v0, "this":Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;
    move-object v1, p1
...
.method private static native filter([IIIIII[IFFFFIIIF[FFFFFFF[IFFFFIIIFFF)V
.end method
...
.method private getDiffuseConstant()F
    ...
    invoke-virtual {v1}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getEffect()Lcom/sun/scenario/effect/PhongLighting;
    ...
    .end local v0    # "this":Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;
    return v0
.end method
...
.method private getKvals()Ljava/nio/FloatBuffer;
    ...
    invoke-virtual {v10, v11}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getInputNativeBounds(I)Lcom/sun/javafx/geom/Rectangle;
    ...
    iget-object v10, v10, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->kvals:Ljava/nio/FloatBuffer;
    ...
    iput-object v11, v10, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->kvals:Ljava/nio/FloatBuffer;
    ...
    invoke-direct {v10}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getSurfaceScale()F
...
.method private getLightPosition()[F
    ...
    .line 82
    invoke-virtual {v2}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getEffect()Lcom/sun/scenario/effect/PhongLighting;
...
.method public varargs filter(Lcom/sun/scenario/effect/Effect;Lcom/sun/scenario/effect/impl/state/RenderState;Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/scenario/effect/ImageData;
    ...
    .local v1, "this":Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;
    ...
    invoke-virtual/range {v45 .. v46}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->setEffect(Lcom/sun/scenario/effect/Effect;)V
    ...
    invoke-virtual/range {v45 .. v48}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getResultBounds(Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/javafx/geom/Rectangle;
    ...
    invoke-virtual/range {v45 .. v46}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->setDestBounds(Lcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v45 .. v46}, Lcom/sun/scenario/effect/ImageData;->getTransformedImage(Lcom/sun/javafx/geom/Rectangle;)Lcom/sun/scenario/effect/Filterable;

    move-result-object v45

    check-cast v45, Lcom/sun/scenario/effect/impl/HeapImage;
    ...
    invoke-interface/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/HeapImage;->getPhysicalHeight()I
    ...
    invoke-interface/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/HeapImage;->getScanlineStride()I
    ...
    .line 158
    invoke-interface/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/HeapImage;->getPixelArray()[I
    ...
    invoke-direct/range {v46 .. v50}, Lcom/sun/javafx/geom/Rectangle;-><init>(IIII)V
    ...
    invoke-virtual/range {v45 .. v46}, Lcom/sun/scenario/effect/ImageData;->getTransformedBounds(Lcom/sun/javafx/geom/Rectangle;)Lcom/sun/javafx/geom/Rectangle;
    ...
    sget-object v45, Lcom/sun/javafx/geom/transform/BaseTransform;->IDENTITY_TRANSFORM:Lcom/sun/javafx/geom/transform/BaseTransform;
    ...
    invoke-virtual/range {v45 .. v47}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->setInputBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v45 .. v47}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->setInputNativeBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v45 .. v53}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getTextureCoordinates(I[FFFFFLcom/sun/javafx/geom/Rectangle;Lcom/sun/javafx/geom/transform/BaseTransform;)I
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getRenderer()Lcom/sun/scenario/effect/impl/Renderer;
    ...
    invoke-virtual/range {v45 .. v47}, Lcom/sun/scenario/effect/impl/Renderer;->getCompatibleImage(II)Lcom/sun/scenario/effect/impl/PoolFilterable;
    ...
    invoke-interface/range {v46 .. v46}, Lcom/sun/scenario/effect/impl/HeapImage;->getPhysicalWidth()I
    ...
    invoke-virtual/range {v45 .. v47}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->setDestNativeBounds(II)V
    ...
    invoke-direct/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getDiffuseConstant()F
    ...
    invoke-direct/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getKvals()Ljava/nio/FloatBuffer;
    ...
    invoke-virtual/range {v45 .. v45}, Ljava/nio/FloatBuffer;->capacity()I
    ...
    invoke-virtual/range {v45 .. v46}, Ljava/nio/FloatBuffer;->get([F)Ljava/nio/FloatBuffer;
    ...
    invoke-direct/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getLightColor()[F
    ...
    invoke-direct/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getLightPosition()[F
    ...
    invoke-direct/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getSpecularConstant()F
    ...
    invoke-direct/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getSpecularExponent()F
    ...
    invoke-direct/range {v45 .. v45}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getSurfaceScale()F
    ...
    invoke-static/range {v45 .. v77}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->filter([IIIIII[IFFFFIIIF[FFFFFFF[IFFFFIIIFFF)V
    ...
    invoke-virtual/range {v45 .. v46}, Lcom/sun/scenario/effect/ImageData;->releaseTransformedImage(Lcom/sun/scenario/effect/Filterable;)V
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;->getFilterContext()Lcom/sun/scenario/effect/FilterContext;
    ...
    .end local v1    # "this":Lcom/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer;
    return-object v1
.end method

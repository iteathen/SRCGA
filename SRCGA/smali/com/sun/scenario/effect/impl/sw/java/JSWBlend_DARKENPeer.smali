.class public Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;
.super Lcom/sun/scenario/effect/impl/sw/java/JSWEffectPeer;
.source "JSWBlend_DARKENPeer.java"
...
.method public constructor <init>(Lcom/sun/scenario/effect/FilterContext;Lcom/sun/scenario/effect/impl/Renderer;Ljava/lang/String;)V
    ...
    .local v0, "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;
    move-object v1, p1
...
.method private getOpacity()F
    ...
    invoke-virtual {v1}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->getEffect()Lcom/sun/scenario/effect/Blend;
    ...
    .end local v0    # "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;
    return v0
.end method
...
.method public varargs filter(Lcom/sun/scenario/effect/Effect;Lcom/sun/scenario/effect/impl/state/RenderState;Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/scenario/effect/ImageData;
    ...
    .local v2, "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;
    ...
    invoke-virtual/range {v93 .. v94}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->setEffect(Lcom/sun/scenario/effect/Effect;)V
    ...
    invoke-virtual/range {v93 .. v96}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->getResultBounds(Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/javafx/geom/Rectangle;
    ...
    invoke-virtual/range {v93 .. v94}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->setDestBounds(Lcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v93 .. v95}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->setInputBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v93 .. v95}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->setInputNativeBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v93 .. v101}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->getTextureCoordinates(I[FFFFFLcom/sun/javafx/geom/Rectangle;Lcom/sun/javafx/geom/transform/BaseTransform;)I
    ...
    invoke-virtual/range {v93 .. v93}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->getRenderer()Lcom/sun/scenario/effect/impl/Renderer;
    ...
    invoke-virtual/range {v93 .. v95}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->setDestNativeBounds(II)V
    ...
    invoke-direct/range {v93 .. v93}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->getOpacity()F
    ...
    .line 237
    .local v68, "blend_darken_res_x":F
    move/from16 v93, v81

    move/from16 v69, v93

    .line 238
    .local v69, "blend_darken_res_y":F
    move/from16 v93, v82

    move/from16 v70, v93

    .line 239
    .local v70, "blend_darken_res_z":F
    move/from16 v93, v83

    move/from16 v71, v93

    .line 243
    .local v71, "blend_darken_res_w":F
    move/from16 v93, v68
    ...
    .end local v68    # "blend_darken_res_x":F
    .end local v69    # "blend_darken_res_y":F
    .end local v70    # "blend_darken_res_z":F
    .end local v71    # "blend_darken_res_w":F
    ...
    .end local v84    # "max_res_x":F
    .end local v85    # "max_res_y":F
    .end local v86    # "max_res_z":F
    ...
    .local v68, "blend_darken_res_x":F
    .local v69, "blend_darken_res_y":F
    .restart local v70    # "blend_darken_res_z":F
    .restart local v71    # "blend_darken_res_w":F
    .restart local v80    # "res_x":F
    .restart local v81    # "res_y":F
    .restart local v82    # "res_z":F
    .restart local v86    # "max_res_z":F
    :cond_f
    move/from16 v93, v42
    ...
    invoke-virtual/range {v95 .. v95}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;->getFilterContext()Lcom/sun/scenario/effect/FilterContext;
    ...
    .end local v2    # "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_DARKENPeer;
    return-object v2
.end method

.class public Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;
.super Lcom/sun/scenario/effect/impl/sw/sse/SSEEffectPeer;
.source "SSEBrightpassPeer.java"
...
.method public constructor <init>(Lcom/sun/scenario/effect/FilterContext;Lcom/sun/scenario/effect/impl/Renderer;Ljava/lang/String;)V
    ...
    .local v0, "this":Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;
    move-object v1, p1
...
.method private getThreshold()F
    ...
    invoke-virtual {v1}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->getEffect()Lcom/sun/scenario/effect/Brightpass;
    ...
    .end local v0    # "this":Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;
    return v0
.end method
...
.method public varargs filter(Lcom/sun/scenario/effect/Effect;Lcom/sun/scenario/effect/impl/state/RenderState;Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/scenario/effect/ImageData;
    ...
    .local v1, "this":Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->setEffect(Lcom/sun/scenario/effect/Effect;)V
    ...
    invoke-virtual/range {v27 .. v30}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->getResultBounds(Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/javafx/geom/Rectangle;
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->setDestBounds(Lcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v27 .. v29}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->setInputBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v27 .. v29}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->setInputNativeBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v27 .. v35}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->getTextureCoordinates(I[FFFFFLcom/sun/javafx/geom/Rectangle;Lcom/sun/javafx/geom/transform/BaseTransform;)I
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->getRenderer()Lcom/sun/scenario/effect/impl/Renderer;
    ...
    invoke-virtual/range {v27 .. v29}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->setDestNativeBounds(II)V
    ...
    invoke-direct/range {v27 .. v27}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->getThreshold()F
    ...
    invoke-static/range {v27 .. v41}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->filter([IIIIII[IFFFFIIIF)V
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;->getFilterContext()Lcom/sun/scenario/effect/FilterContext;
    ...
    .end local v1    # "this":Lcom/sun/scenario/effect/impl/sw/sse/SSEBrightpassPeer;
    return-object v1
.end method

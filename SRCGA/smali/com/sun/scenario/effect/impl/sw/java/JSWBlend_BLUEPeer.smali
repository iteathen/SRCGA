.class public Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;
.super Lcom/sun/scenario/effect/impl/sw/java/JSWEffectPeer;
.source "JSWBlend_BLUEPeer.java"
...
.method public constructor <init>(Lcom/sun/scenario/effect/FilterContext;Lcom/sun/scenario/effect/impl/Renderer;Ljava/lang/String;)V
    ...
    .local v0, "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;
    move-object v1, p1
...
.method private getOpacity()F
    ...
    invoke-virtual {v1}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->getEffect()Lcom/sun/scenario/effect/Blend;
    ...
    .end local v0    # "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;
    return v0
.end method
...
.method public varargs filter(Lcom/sun/scenario/effect/Effect;Lcom/sun/scenario/effect/impl/state/RenderState;Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/scenario/effect/ImageData;
    ...
    .local v2, "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;
    ...
    invoke-virtual/range {v84 .. v85}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->setEffect(Lcom/sun/scenario/effect/Effect;)V
    ...
    invoke-virtual/range {v84 .. v87}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->getResultBounds(Lcom/sun/javafx/geom/transform/BaseTransform;Lcom/sun/javafx/geom/Rectangle;[Lcom/sun/scenario/effect/ImageData;)Lcom/sun/javafx/geom/Rectangle;
    ...
    invoke-virtual/range {v84 .. v85}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->setDestBounds(Lcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v84 .. v86}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->setInputBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v84 .. v86}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->setInputNativeBounds(ILcom/sun/javafx/geom/Rectangle;)V
    ...
    invoke-virtual/range {v84 .. v92}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->getTextureCoordinates(I[FFFFFLcom/sun/javafx/geom/Rectangle;Lcom/sun/javafx/geom/transform/BaseTransform;)I
    ...
    invoke-virtual/range {v84 .. v84}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->getRenderer()Lcom/sun/scenario/effect/impl/Renderer;
    ...
    invoke-virtual/range {v84 .. v86}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->setDestNativeBounds(II)V
    ...
    invoke-direct/range {v84 .. v84}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->getOpacity()F
    ...
    .line 224
    .local v68, "blend_blue_res_x":F
    move/from16 v84, v81

    move/from16 v69, v84

    .line 225
    .local v69, "blend_blue_res_y":F
    move/from16 v84, v82

    move/from16 v70, v84

    .line 226
    .local v70, "blend_blue_res_z":F
    move/from16 v84, v83

    move/from16 v71, v84

    .line 230
    .local v71, "blend_blue_res_w":F
    move/from16 v84, v68
    ...
    .end local v68    # "blend_blue_res_x":F
    .end local v69    # "blend_blue_res_y":F
    .end local v70    # "blend_blue_res_z":F
    .end local v71    # "blend_blue_res_w":F
    ...
    .local v68, "blend_blue_res_x":F
    .local v69, "blend_blue_res_y":F
    .restart local v70    # "blend_blue_res_z":F
    .restart local v71    # "blend_blue_res_w":F
    ...
    invoke-virtual/range {v86 .. v86}, Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;->getFilterContext()Lcom/sun/scenario/effect/FilterContext;
    ...
    .end local v2    # "this":Lcom/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer;
    return-object v2
.end method

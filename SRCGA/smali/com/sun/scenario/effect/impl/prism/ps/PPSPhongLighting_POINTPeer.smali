.class public Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;
.super Lcom/sun/scenario/effect/impl/prism/ps/PPSTwoSamplerPeer;
.source "PPSPhongLighting_POINTPeer.java"
...
.method public constructor <init>(Lcom/sun/scenario/effect/FilterContext;Lcom/sun/scenario/effect/impl/Renderer;Ljava/lang/String;)V
    ...
    .local v0, "this":Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;
    move-object v1, p1
...
.method private getDiffuseConstant()F
    ...
    invoke-virtual {v1}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getEffect()Lcom/sun/scenario/effect/PhongLighting;
    ...
    .end local v0    # "this":Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;
    return v0
.end method
...
.method private getKvals()Ljava/nio/FloatBuffer;
    ...
    invoke-virtual {v10, v11}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getInputNativeBounds(I)Lcom/sun/javafx/geom/Rectangle;
    ...
    iget-object v10, v10, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->kvals:Ljava/nio/FloatBuffer;
    ...
    iput-object v11, v10, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->kvals:Ljava/nio/FloatBuffer;
    ...
    invoke-direct {v10}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getSurfaceScale()F
...
.method private getLightPosition()[F
    ...
    .line 80
    invoke-virtual {v2}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getEffect()Lcom/sun/scenario/effect/PhongLighting;
...
.method protected createShader()Lcom/sun/prism/ps/Shader;
    ...
    invoke-virtual {v3}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getRenderer()Lcom/sun/scenario/effect/impl/prism/ps/PPSRenderer;

    move-result-object v3

    move-object v4, v0

    invoke-virtual {v4}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getShaderName()Ljava/lang/String;
...
.method protected updateShader(Lcom/sun/prism/ps/Shader;)V
    ...
    invoke-direct {v4}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getLightPosition()[F
    ...
    invoke-direct {v6}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getSpecularExponent()F
    ...
    invoke-direct {v6}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getKvals()Ljava/nio/FloatBuffer;
    ...
    invoke-direct {v8}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getKvalsArrayLength()I
    ...
    invoke-direct {v6}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getDiffuseConstant()F
    ...
    invoke-direct {v4}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getLightColor()[F
    ...
    invoke-direct {v6}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getSpecularConstant()F
    ...
    const-string v5, "surfaceScale"

    move-object v6, v0

    invoke-direct {v6}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer;->getSurfaceScale()F

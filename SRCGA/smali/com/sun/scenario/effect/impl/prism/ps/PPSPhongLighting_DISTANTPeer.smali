.class public Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;
.super Lcom/sun/scenario/effect/impl/prism/ps/PPSTwoSamplerPeer;
.source "PPSPhongLighting_DISTANTPeer.java"
...
.method public constructor <init>(Lcom/sun/scenario/effect/FilterContext;Lcom/sun/scenario/effect/impl/Renderer;Ljava/lang/String;)V
    ...
    .local v0, "this":Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;
    move-object v1, p1
...
.method private getDiffuseConstant()F
    ...
    invoke-virtual {v1}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getEffect()Lcom/sun/scenario/effect/PhongLighting;
    ...
    .end local v0    # "this":Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;
    return v0
.end method
...
.method private getKvals()Ljava/nio/FloatBuffer;
    ...
    invoke-virtual {v10, v11}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getInputNativeBounds(I)Lcom/sun/javafx/geom/Rectangle;
    ...
    iget-object v10, v10, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->kvals:Ljava/nio/FloatBuffer;
    ...
    iput-object v11, v10, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->kvals:Ljava/nio/FloatBuffer;
    ...
    invoke-direct {v10}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getSurfaceScale()F
...
.method private getLightPosition()[F
    ...
    .line 80
    invoke-virtual {v2}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getEffect()Lcom/sun/scenario/effect/PhongLighting;
...
.method protected createShader()Lcom/sun/prism/ps/Shader;
    ...
    const-string v4, "normalizedLightPosition"
    ...
    invoke-virtual {v3}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getRenderer()Lcom/sun/scenario/effect/impl/prism/ps/PPSRenderer;

    move-result-object v3

    move-object v4, v0

    invoke-virtual {v4}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getShaderName()Ljava/lang/String;
...
.method protected updateShader(Lcom/sun/prism/ps/Shader;)V
    ...
    invoke-direct {v4}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getNormalizedLightPosition()[F
    ...
    .line 166
    .local v2, "normalizedLightPosition_tmp":[F
    move-object v4, v1

    const-string v5, "normalizedLightPosition"
    ...
    invoke-interface {v4, v5, v6, v7, v8}, Lcom/sun/prism/ps/Shader;->setConstant(Ljava/lang/String;FFF)V

    .line 167
    move-object v4, v1

    const-string v5, "specularExponent"

    move-object v6, v0

    invoke-direct {v6}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getSpecularExponent()F
    ...
    const-string v5, "kvals"

    move-object v6, v0

    invoke-direct {v6}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getKvals()Ljava/nio/FloatBuffer;
    ...
    invoke-direct {v8}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getKvalsArrayLength()I
    ...
    const-string v5, "diffuseConstant"

    move-object v6, v0

    invoke-direct {v6}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getDiffuseConstant()F
    ...
    invoke-direct {v4}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getLightColor()[F
    ...
    const-string v5, "specularConstant"

    move-object v6, v0

    invoke-direct {v6}, Lcom/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer;->getSpecularConstant()F

.class final Lcom/sun/glass/ui/monocle/MonoclePixels;
.super Lcom/sun/glass/ui/Pixels;
.source "MonoclePixels.java"
...
.method constructor <init>(IILjava/nio/ByteBuffer;)V
    ...
    .local v0, "this":Lcom/sun/glass/ui/monocle/MonoclePixels;
    move v1, p1
...
.method constructor <init>(IILjava/nio/IntBuffer;F)V
    .locals 10
...
.method private _copyPixels(Ljava/nio/Buffer;Ljava/nio/Buffer;I)V
    .locals 8
    ...
    .local v1, "dst":Ljava/nio/Buffer;
    move-object v2, p2

    .local v2, "src":Ljava/nio/Buffer;
    move v3, p3
...
.method protected _attachByte(JIILjava/nio/ByteBuffer;[BI)V
    ...
    .local v1, "this":Lcom/sun/glass/ui/monocle/MonoclePixels;
    move-wide v2, p1
...
.method protected _fillDirectByteBuffer(Ljava/nio/ByteBuffer;)V
    ...
    iget-object v4, v4, Lcom/sun/glass/ui/monocle/MonoclePixels;->bytes:Ljava/nio/ByteBuffer;
    ...
    iget-object v6, v6, Lcom/sun/glass/ui/monocle/MonoclePixels;->bytes:Ljava/nio/ByteBuffer;

    move-object v7, v0

    invoke-virtual {v7}, Lcom/sun/glass/ui/monocle/MonoclePixels;->getWidth()I

    move-result v7

    move-object v8, v0

    invoke-virtual {v8}, Lcom/sun/glass/ui/monocle/MonoclePixels;->getHeight()I

    move-result v8

    mul-int/2addr v7, v8

    invoke-direct {v4, v5, v6, v7}, Lcom/sun/glass/ui/monocle/MonoclePixels;->_copyPixels(Ljava/nio/Buffer;Ljava/nio/Buffer;I)V
    ...
    iget-object v5, v5, Lcom/sun/glass/ui/monocle/MonoclePixels;->bytes:Ljava/nio/ByteBuffer;
    ...
    iget-object v4, v4, Lcom/sun/glass/ui/monocle/MonoclePixels;->ints:Ljava/nio/IntBuffer;
    ...
    iget-object v6, v6, Lcom/sun/glass/ui/monocle/MonoclePixels;->ints:Ljava/nio/IntBuffer;
    ...
    iget-object v5, v5, Lcom/sun/glass/ui/monocle/MonoclePixels;->ints:Ljava/nio/IntBuffer;

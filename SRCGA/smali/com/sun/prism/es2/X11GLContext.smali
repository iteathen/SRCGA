.class Lcom/sun/prism/es2/X11GLContext;
.super Lcom/sun/prism/es2/GLContext;
.source "X11GLContext.java"
...
.method constructor <init>(J)V
    ...
    .local v0, "this":Lcom/sun/prism/es2/X11GLContext;
    move-wide v1, p1
    ...
    iput-wide v4, v3, Lcom/sun/prism/es2/X11GLContext;->nativeCtxInfo:J
...
.method constructor <init>(Lcom/sun/prism/es2/GLDrawable;Lcom/sun/prism/es2/GLPixelFormat;Z)V
    ...
    .local v1, "this":Lcom/sun/prism/es2/X11GLContext;
    move-object v2, p1
    ...
    .line 58
    invoke-static {v8, v9, v10, v11, v12}, Lcom/sun/prism/es2/X11GLContext;->nInitialize(JJZ)J

    move-result-wide v8

    iput-wide v8, v7, Lcom/sun/prism/es2/X11GLContext;->nativeCtxInfo:J
...
.method getNativeHandle()J
    ...
    iget-wide v2, v2, Lcom/sun/prism/es2/X11GLContext;->nativeCtxInfo:J

    invoke-static {v2, v3}, Lcom/sun/prism/es2/X11GLContext;->nGetNativeHandle(J)J

    move-result-wide v2

    move-wide v1, v2

    .end local v1    # "this":Lcom/sun/prism/es2/X11GLContext;
    return-wide v1
.end method
...
.method makeCurrent(Lcom/sun/prism/es2/GLDrawable;)V
    ...
    invoke-static {v2, v3, v4, v5}, Lcom/sun/prism/es2/X11GLContext;->nMakeCurrent(JJ)V

.class Lcom/sun/prism/es2/EGLX11GLDrawable;
.super Lcom/sun/prism/es2/GLDrawable;
.source "EGLX11GLDrawable.java"
...
.method constructor <init>(JLcom/sun/prism/es2/GLPixelFormat;)V
    ...
    .local v0, "this":Lcom/sun/prism/es2/EGLX11GLDrawable;
    move-wide v1, p1
    ...
    invoke-static {v6, v7, v8, v9}, Lcom/sun/prism/es2/EGLX11GLDrawable;->nCreateDrawable(JJ)J
    ...
    invoke-virtual {v6, v7, v8}, Lcom/sun/prism/es2/EGLX11GLDrawable;->setNativeDrawableInfo(J)V
...
.method constructor <init>(Lcom/sun/prism/es2/GLPixelFormat;)V
    ...
    invoke-static {v4, v5}, Lcom/sun/prism/es2/EGLX11GLDrawable;->nGetDummyDrawable(J)J
    ...
    invoke-virtual {v4, v5, v6}, Lcom/sun/prism/es2/EGLX11GLDrawable;->setNativeDrawableInfo(J)V
...
.method swapBuffers(Lcom/sun/prism/es2/GLContext;)Z
    ...
    invoke-virtual {v2}, Lcom/sun/prism/es2/EGLX11GLDrawable;->getNativeDrawableInfo()J

    move-result-wide v2

    invoke-static {v2, v3}, Lcom/sun/prism/es2/EGLX11GLDrawable;->nSwapBuffers(J)Z

    move-result v2

    move v0, v2

    .end local v0    # "this":Lcom/sun/prism/es2/EGLX11GLDrawable;
    return v0
.end method
